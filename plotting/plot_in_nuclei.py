...
COLUMN_SUFFIX_TO_LABEL = {
    "_total_marker_per_pod_divided_by_pod_size": "_Normalised_by_Podocyte_Size",
    "total_marker_norm_by_minmax_of_nuclei_channel_divided_by_pod_size": "_Normalised_by_Podocyte_Size+DAPI",
    "_total_marker_norm_by_minmax_of_nuclei_channel": "_Normalised_by_DAPI_only",
}

TARGET_SUFFIX = "total_marker_per_pod_divided_by_pod_size"
