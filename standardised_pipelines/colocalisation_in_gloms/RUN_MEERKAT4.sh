...
MANUAL_MASKS="/path/to/manual_glom_masks"
...
--singularity_image /group/kidn4/ACTIVE/COLOCALISATION_PIPELINE/containers/colocalisation_seaborn_pptx.sif \
...
--manual_glom_folder ${MANUAL_MASKS}
